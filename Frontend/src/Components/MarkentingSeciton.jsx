...
const items = [
  ...
  { text: "ডিজিটাল মার্কেটিং", position: "top-1/2 left-[-20px] -translate-y-1/2" },
];
    ...
    <div className=" bg-green-300/10">
        <Container>
            <div className=" flex justify-between items-center">
                <div className="">
                <h3 className=' text-5xl font-bold text-green-800'>ডিজিটাল মার্কেটিং কি?</h3>
                <h3 className=' font-bold text-3xl mt-7 text-red-700'>ডিজিটাল মার্কেটিং এর প্রয়োজনীয়তা</h3>
      ...
      <div className="relative w-[500px] h-[500px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-10">
          <p className="text-gray-700 text-sm">
            এসইও বা সার্চ ইঞ্জিন অপ্টিমাইজেশন, এসইএম বা সার্চ ইঞ্জিন মার্কেটিং,
            কন্টেন্ট মার্কেটিং, সোশ্যাল মিডিয়া মার্কেটিং, ইমেইল মার্কেটিং,
            ইনফ্লুয়েন্সার মার্কেটিং।
          </p>
        </div>
